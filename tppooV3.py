	...
	def widgets(self):
		...
		def combat():
			...
			if type(DeckJ1[idun]).__name__=='Chamane' or type(DeckJ1[idun]).__name__=='Mage_Blanc' or type(DeckJ1[idun]).__name__=='Pretre':
				...
				atkant=DeckJ1[idun]
				atké=DeckJ2[random.randint(1,10)]
		...
		def ligneUn(event):
			idun=1+ListeJ1.curselection()[0]
			if type(DeckJ1[idun]).__name__=='Chevalier_Gryffon' or type(DeckJ1[idun]).__name__=='Chevalier_Sacre' or type(DeckJ1[idun]).__name__=='Moine':
		...
		def ligneDeux(event):
			...
			if type(DeckJ2[ideu]).__name__=='Chevalier_Gryffon' or type(DeckJ2[ideu]).__name__=='Chevalier_Sacre' or type(DeckJ2[ideu]).__name__=='Moine':
